      ...
      <S.SidebarMenu>
        <Link href="/assets">
          <S.SidebarMenuItem>
            ...
            <S.SidebarMenuItemLabel>Conteúdo</S.SidebarMenuItemLabel>
          </S.SidebarMenuItem>
        </Link>
        <Link href="/logo">
          <S.SidebarMenuItem>
            ...
            <S.SidebarMenuItemLabel>Logo</S.SidebarMenuItemLabel>
          </S.SidebarMenuItem>
        </Link>
        <Link href="/cores">
          <S.SidebarMenuItem>
            ...
            <S.SidebarMenuItemLabel>Cores</S.SidebarMenuItemLabel>
          </S.SidebarMenuItem>
        </Link>
        <Link href="/tipografia">
          <S.SidebarMenuItem>
            <S.Icon viewBox="0 0 20 20">
              <path
                width="20px"
            ...
            <S.SidebarMenuItemLabel>Tipografia</S.SidebarMenuItemLabel>
          </S.SidebarMenuItem>
        </Link>
        <Link href="/marca">
          <S.SidebarMenuItem>
            <S.Icon viewBox="0 0 20 19">
              <path
                width="20px"
                height="19px"
                fill="white"
            ...
            <S.SidebarMenuItemLabel>Marca</S.SidebarMenuItemLabel>
          </S.SidebarMenuItem>
        </Link>
        <Link href="/equipe">
          <S.SidebarMenuItem>
            ...
            <S.SidebarMenuItemLabel>Equipe</S.SidebarMenuItemLabel>
          </S.SidebarMenuItem>
        </Link>
      </S.SidebarMenu>
    </S.SidebarContainer>
